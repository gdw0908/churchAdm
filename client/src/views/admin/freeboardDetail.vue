      ...
      <main class="main_wrap">
        ...
        <div class="container inner">
          <article class="user_qna_wrap free_wrap">
            ...
            <div class="con">
              문의 내용이 나타납니다.문의 내용이 나타납니다.문의 내용이
              나타납니다.문의 내용이 나타납니다.문의 내용이 나타납니다.문의
              내용이 나타납니다.문의 내용이 나타납니다.문의 내용이
              나타납니다.문의 내용이 나타납니다.문의 내용이 나타납니다 .문의
              내용이 나타납니다.문의 내용이 나타납니다.문의 내용이
              나타납니다.문의 내용이 나타납니다. 문의 내용이 나타납니다.문의
              내용이 나타납니다.문의 내용이 나타납니다.문의 내용이
              ...
              내용이 나타납니다.문의 내용이 나타납니다.문의 내용이
              나타납니다.문의 내용이 나타납니다 .문의 내용이 나타납니다.문의
              내용이 나타납니다.문의 내용이 나타납니다.문의 내용이 나타납니다.
            </div>
            ...
            <ul class="reply_list">
              <li class="reply_item">
                <ul>
                  ...
                  <li class="content">
                    댓글
                    보여지는곳ㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇ
                    ㅇㄹ ㅇㄹ ㅇ ㄹㅇ ㄹ ㄹㅇ ㄹㅇ
                  </li>
                </ul>
                <button type="button" class="delete_btn">
              ...
              <ul class="nested_reply_list">
                <li class="reply_item">
                  <ul>
                    ...
                    <li class="content">
                      대댓글
                      보여지는곳ㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇㄹㅇ
                      ㄹㅇ ㄹ ㅇㄹㅇ ㄹㅇ ㄹㅇ
                    </li>
                  </ul>
                  <button type="button" class="delete_btn">
...
export default {
  ...
  methods: {
    ...
    async getDetail() {
      let freeboardInfo = await this.$api('/apirole/freeboardDetail', {
        param: [this.keyword],
      })
      ...
      this.$swal
        ...
        .then(async (result) => {
          if (result.isConfirmed) {
            ...
            await this.$api('/apirole/freeboardDelete', {
              param: [this.user.MEMBER_ID, article_seq],
            })
            this.goList()
